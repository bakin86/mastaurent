...
import { CLERK_KEY, clerkEnabled } from './lib/clerk';

if (!clerkEnabled) {
  console.warn(
    '[Masteurent] VITE_CLERK_PUBLISHABLE_KEY тохируулаагүй байна — ' +
      'нэвтрэлт идэвхгүй. Бусад бүх хэсэг хэвийн ажиллана.',
  );
}
